...
public final class SelectBudgetActivity_MembersInjector
    implements MembersInjector<SelectBudgetActivity> {
  ...
  public SelectBudgetActivity_MembersInjector(
  ...
  public static MembersInjector<SelectBudgetActivity> create(
      Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider,
      Provider<DispatchingAndroidInjector<android.app.Fragment>>
          frameworkFragmentInjectorProvider) {
    return new SelectBudgetActivity_MembersInjector(
        supportFragmentInjectorProvider, frameworkFragmentInjectorProvider);
  }

  @Override
  public void injectMembers(SelectBudgetActivity instance) {
